const reportsData = {
  emotional: {
    ...
    questions: [
      ...
      { en: "I can control impulses when I’m upset.", hi: "मैं परेशान होने पर अपने आवेगों को नियंत्रित कर सकता हूँ।", bn: "আমি বিরক্ত হলে আমার আবেগ নিয়ন্ত্রণ করতে পারি।" },
      { en: "I understand how others feel in social situations.", hi: "मैं सामाजिक परिस्थितियों में दूसरों की भावनाओं को समझता हूँ।", bn: "আমি সামাজিক পরিস্থিতিতে অন্যদের অনুভূতি বুঝতে পারি।" },
  ...
  growth: {
    ...
    questions: [
      ...
      { en: "I believe my abilities can improve with effort.", hi: "मुझे विश्वास है कि प्रयास से मेरी क्षमताएँ बढ़ सकती हैं।", bn: "আমি বিশ্বাস করি যে চেষ্টা করে আমার দক্ষতা উন্নত হতে পারে।" },
